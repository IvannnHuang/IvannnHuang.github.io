...
void storeData() {
  ...
  if (!recording && imu_data1_index > 0 && !finish) {
    for (int i = 0; i < imu_data1_index; i++) {tx_estring_value.clear();
        tx_estring_value.append("Time:");
        tx_estring_value.append(double(timestamps1[i]));
        tx_estring_value.append(", ");
        tx_estring_value.append(double(imu_data1[i][0]));
        tx_estring_value.append(", ");
        tx_estring_value.append(double(imu_data1[i][1]));
        tx_estring_value.append(", ");
        tx_estring_value.append(double(imu_data1[i][2]));
        tx_estring_value.append(", ");
        tx_estring_value.append(double(imu_data1[i][3]));
        tx_estring_value.append(", ");
        tx_estring_value.append(double(imu_data1[i][4]));
        tx_estring_value.append(", ");
        tx_estring_value.append(double(imu_data1[i][5]));
        tx_estring_value.append(", ");
        tx_estring_value.append(double(imu_data1[i][6]));
        tx_estring_value.append(", ");
        tx_estring_value.append(double(imu_data1[i][7]));
        tx_estring_value.append(", ");
        tx_estring_value.append(double(imu_data1[i][8]));
        tx_estring_value.append(", ");
        tx_estring_value.append(double(imu_data1[i][9]));
        tx_characteristic_string.writeValue(tx_estring_value.c_str());
        data_count--;
    }

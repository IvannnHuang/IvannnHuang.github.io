...
class Localization(BaseLocalization):
    ...
    def plot_update_step_data(self, plot_data=True):
        ...
        # return the belief value to be used for next waypoint visit
        return [current_belief[0], current_belief[1]]

    def plot_pose(self, bel1, bel2, bel3, truth1, truth2, truth3):
        self.cmdr.plot_bel(bel1[0],bel1[1])
        self.cmdr.plot_bel(bel2[0],bel2[1])
        self.cmdr.plot_bel(bel3[0],bel3[1])
        self.cmdr.plot_gt(truth1[0],truth1[1])
        self.cmdr.plot_gt(truth2[0],truth2[1])
        self.cmdr.plot_gt(truth3[0],truth3[1])
